...
3) Choose **Up to Next Major Version** and set `5.1.0` (or `5.1` tag).  
...
```swift
dependencies: [
    .package(url: "https://github.com/hawcx/hawcx_ios_sdk.git", from: "5.1.0")
]
```

Manual option: download `HawcxFramework.xcframework.zip` from the [5.1 release](https://github.com/hawcx/hawcx_ios_sdk/releases/5.1), unzip, and embed the XCFramework with “Embed & Sign”.
